...
$(document).ready(function () {
    ...
    $('#cortina_musica').mouseleave(function () {
        if($('#cortina_musica').hasClass('misericordiaque')) { // Evalúa si tiene la clase miserocordiaque
            $('#cortina_musica')
    ...
    $('#cortina_contactos').mouseleave(function () {
        if($('#cortina_contactos').hasClass('death')) { // Evalúa si tiene la clase death
            $('#cortina_contactos')
                .removeClass('death') // Remueve clase death de cortina_contactos
                .addClass('sexy') // Agrega clase sexy a cortina_contactos
                .slideUp(400) // Oculta cortina_contactos
    ...
    $('#cortina_eventos_pasados').mouseleave(function () {
        if($('#cortina_eventos_pasados').hasClass('messiah')) { // Evalúa si tiene la clase death
    ...
    $('#cortina_proximos_eventos').mouseleave(function () {
        if($('#cortina_proximos_eventos').hasClass('allTheHate')) { // Evalúa si tiene la clase death
    ...
    $('#cortina_redes_sociales').mouseleave(function () {
        if($('#cortina_redes_sociales').hasClass('evilution')) { // Evalúa si tiene la clase death
